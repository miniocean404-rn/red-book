...
export default forwardRef((props: Props, ref) => {
  ...
  const [myList, setMyList] = useState<CategoryData[]>([])
  const [otherList, setOtherList] = useState<CategoryData[]>([])
    ...
    return (
      <>
        ...
        <View style={styles.listContent}>
          {myList.map((item: CategoryData, index: number) => {
            return (
              <TouchableOpacity
                key={`${item.name}`}
                style={
  ...
  const renderOtherList = () => {
    return (
      <>
        ...
        <View style={styles.listContent}>
          {otherList.map((item: CategoryData, index: number) => {
            return (
              <TouchableOpacity
                key={`${item.name}`}
