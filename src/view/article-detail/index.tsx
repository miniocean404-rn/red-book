...
import { artcleDetailApi } from '@/api/article'
...
const ArticleDetail = () => {
  ...
  const init = async () => {
    const [_, res] = await artcleDetailApi({ id: params.id })
  ...
  const renderBottom = () => {
    return (
      <View style={styles.bottomLayout}>
        ...
        <Heart size={30} light={detail.isFavorite} />
              ...
              return (
                <View key={`${index}`} style={{}}>
                  <View style={styles.commentItem}>
                            ...
                            return (
                              ...
                              >
                                ...
                                <View style={styles.countLayout}>
                                  <Heart size={20} light={j.isFavorite} />
                    ...
                    <View style={styles.countLayout}>
                      <Heart size={20} light={i.isFavorite} />
